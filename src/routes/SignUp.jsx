    ...
    <div>
      <div className='max-w-[400px] mx-auto min-h-[600px] px-4 py-20'>
        ...
        <form>
          ...
          <button className='w-full my-2 p-3 bg-button text-btnText rounded-2xl drop-shadow-xl'>Sign Up</button>
        </form>
        <p className='my-4'>Already have an account?
          <Link to='/signin' className='text-accent ml-2'>Sign In</Link>
        </p>
      </div>
    </div>
  )
